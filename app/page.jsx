...
export const metadata = {
  ...
  description: 'Build production-ready backend systems in minutes with pre-built, modular components. 600+ weekly downloads, 100+ active users from 6+ countries. Authentication, databases, APIs, and more.',
  keywords: [
    'Backternity',
    'Backend Components',
    'Modular Backend',
  ...
  openGraph: {
    title: 'Backternity | Build Scalable Backends with Modular Components',
    description: 'Build production-ready backend systems in minutes. 600+ weekly downloads, 100+ active users.',

...
PORT=3000`,
      ...
      frontendUsage: {
        ...
        endpoints: [
          {
            route: "/api/crud/:model",
            method: "POST",
            description: "Create a new document for the specified model.",
          },
          {
            route: "/api/crud/:model",
            method: "GET",
            description:
              "Fetch all documents for a given model (supports query filters).",
          },
          {
            route: "/api/crud/:model/:id",
            method: "PUT",
...
NODE_ENV=development`,
      ...
      frontendUsage: {
        ...
        endpoints: [
          {
            route: "Middleware: logger.http()",
            method: "–",
            description:
              "Logs all incoming HTTP requests with status and response time.",
          },
          {
            route: "Middleware: logger.error()",
            method: "–",
            description:
              "Logs uncaught exceptions and errors with stack traces.",
          },
          {
            route: "Middleware: logger.info()",
            method: "–",
            description:
              "Logs application events like startup, user actions, etc.",
          },
        ],
      ...
      frontendUsage: {
        ...
        endpoints: [
          ...
          },
          {
            ...
            method: "GET",
            description:
              "Opens Bull Board UI for queue monitoring and management.",
          },
        ],

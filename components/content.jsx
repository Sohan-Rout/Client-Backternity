...
export default function Content() {
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-28 md:py-32 bg-gradient-to-b from-neutral-950 via-neutral-950 to-[#001510] text-neutral-100">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-20 items-center mb-24">
          ...
          >
            {/* Subtle Emerald Glows */}
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-emerald-500/10 rounded-full blur-[80px]" />
            <div className="absolute bottom-0 -left-10 w-48 h-48 bg-emerald-400/10 rounded-full blur-[100px]" />
          ...
          >
            <div>
              ...
              <p className="text-sm sm:text-base text-neutral-400 leading-relaxed">
                ...
                together seamlessly. <b>Skip the setup — build what matters.</b>
              </p>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              {architectureSteps.map((step, index) => (
                ...
                >
                  <div className="flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 bg-emerald-500/10 rounded-md flex-shrink-0">
            ...
            {capabilities.map((cap, index) => (
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="p-2 bg-emerald-500/10 rounded-md group-hover:bg-emerald-500/20 transition-all flex-shrink-0">
